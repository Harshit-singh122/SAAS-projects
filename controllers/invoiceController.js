...
//computes total ,tax and subtotal
...
//parses items field from request body
...
//for helper function to upload ing files to public  URL
...
export async function getInvoiceById(req, res) {
    try {
        ...
        console.error("GET INVOICES BY ID ERROR:", err);
        return res.status(500).json({
            success: false,
            message: "Server error"
        });
...
export async function updateInvoice(req, res) {
    try {
        ...
        //ensure that it not exist already or not in use
        ...
        //to update we can update these things
        const update = {
