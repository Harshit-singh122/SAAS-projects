...
const BusinessProfile = () => {
    ...
    //h you can remove any preview file locally
        ...
        <div className={businessProfileStyles.pageContainer}>
            <div className={businessProfileStyles.headerContainer}>
                ...
                <p className={businessProfileStyles.headerSubtitle}>
                    Configate you company details branding assets and invoice default
                </p>
                {!isSignedIn && (
                    <div style={{
                        marginTop: 12,
                        ...
                        you are not signed in change cannot be saved here please signed
                        in to load and save bussiness profile
                    </div>
                )}
            </div>
                            ...
                            <div>
                                ...
                                <div className={businessProfileStyles.taxContainer}>
                                    ...
                                    <p className={businessProfileStyles.taxHelpText}>
                                        This tax rate will prefill in the new invoices you can adjust it per invoice needed
                                    </p>
                                </div>
                            </div>
                        </div>
