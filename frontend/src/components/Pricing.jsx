...
import { pricingStyles, pricingCardStyles } from '../assets/dummystyle'
...
const PricingCard = ({
    ...
    >
        ...
        {isPopular && (
            <>
                <div className={pricingCardStyles.cornerAccent1}>Most Popular</div>
                <div className={pricingCardStyles.cornerAccent2}>Most Popular</div>
            </>
        )}
    </div>
...
const Pricing = () => {
    ...
    function handleCtaClick(planMata, flags = {}) {
        ...
        navigate("/app/create-invoice", {
            state: { fromPlan: planMata?.title || null }
        })
    }
            ...
            <div className={pricingStyles.container}>
                <div className={pricingStyles.headerContainer}>
                    ...
                    <p className={pricingStyles.description}>
                        start free, upgrade as you grow. No hidden fees, no surprises charges
                    </p>
