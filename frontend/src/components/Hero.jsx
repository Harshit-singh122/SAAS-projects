...
import { appShellStyles, heroStyles } from '../assets/dummystyle'
                            ...
                            <div className={heroStyles.demoCard}>
                                <div className={heroStyles.cardHeader}>
                                    ...
                                    <div className={heroStyles.cardInvoiceInfo}>
                                        ...
                                        <div className={heroStyles.cardInvoiceNumber}>INV-2024</div>
                                ...
                                <div className={heroStyles.actionButtons}>
                                    <button className={heroStyles.previewButtonButton}>
